	...
	public static void Chartlinkdata() throws InterruptedException {
		try {
			...
			List<WebElement> data = driver.findElements(
					By.xpath("//table[@class='rounded-b-[0.4375rem] min-w-max lg:w-full whitespace-nowrap']//tbody//tr/td[position()=3 or position()=5]']//tbody//tr/td[position()=3 or position()=5]"));
